...
/**
 * A simple {@link Fragment} subclass. Containing logic for embedding the system "Platzfinder".
 */
public class PlatzfinderFragment extends Fragment {

    private WebView webView;

    //which website should be parsed?
    private String parseUrl = "https://www.ub.uni-muenchen.de/arbeiten/platzfinder/index.html";
    private ProgressBar loadingPanel;

    public PlatzfinderFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_platzfinder, container, false);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.loadUrl("javascript:(function() { " +
                                ...
                                //trim last two paragraphs to prevent the user from following the provided links
                                "var p = document.getElementsByTagName('p');"+
                                "document.getElementsByTagName('p')[p.length-1].style.display='none';"+
                                "document.getElementsByTagName('p')[p.length-2].style.display='none';"+
                                "})()");
                //hide loading panel
