 ...
 * 
 * Das Skript beinhaltet die clientseitige Logik, um eine Verknuepfung zwischen
 * LocationID und ContentID zu speichern. Es uebernimmt den Aufruf zum 
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.type == 'error') {
                        ...
                        $('#result').attr("role", "alert");
                        $('#result').html('Speichern der Verkn&uuml;pfung zwischen LocationID ' + data.location_id + ' und ContentID ' + data.content_id + ' erfolgreich!').slideDown("Slow");
                    }
                }
            });
        } else {
